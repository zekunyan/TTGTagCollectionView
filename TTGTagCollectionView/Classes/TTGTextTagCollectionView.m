...
- (void)updateStyleAndFrameForLabel:(TTGTextTagLabel *)label {
    ...
    if (config.tagGradientBackgroundStartColor != nil || config.tagGradientBackgroundEndColor != nil) {
        label.label.backgroundColor = label.selected ? config.tagSelectedBackgroundColor : [UIColor clearColor];
